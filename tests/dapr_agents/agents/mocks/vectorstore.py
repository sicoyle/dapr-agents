...
class MockVectorStore(VectorStoreBase):
    ...
    def add(self, documents: List[str], metadatas: Optional[List[Dict[str, Any]]] = None, ids: Optional[List[str]] = None) -> List[str]:
    ...
    def search_similar(self, query_embeddings: List[List[float]], n_results: int = 4, where: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """Mock implementation of search_similar."""
        return {"documents": [], "metadatas": [], "embeddings": [], "ids": [], "distances": []} 