...
class TestScenarioManager:
    ...
    def test_get_component_config_dir(self):
        ...
        # Test each scenario
        local_full_dir = manager.get_component_config_dir(DevelopmentScenario.LOCAL_FULL)
        assert "local_dev" in local_full_dir
        
        local_partial_dir = manager.get_component_config_dir(DevelopmentScenario.LOCAL_PARTIAL)
        assert "partial_dev" in local_partial_dir
        
        agent_only_dir = manager.get_component_config_dir(DevelopmentScenario.AGENT_ONLY)
        assert "production" in agent_only_dir
        
        production_dir = manager.get_component_config_dir(DevelopmentScenario.PRODUCTION)
