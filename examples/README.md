...
3. Choose an example from the list below. Or click [here](./01-hello-world) to start with Hello-World.
...
*Note: Other examples for specific clients are available for [Elevenlabs](./02-llm-call-elevenlabs), [Hugging Face](./02-llm-call-hugging-face), and [Nvidia](./02-llm-call-nvidia).*
...
This example demonstrates how to instrument standalone agents for comprehensive observability and debugging.
