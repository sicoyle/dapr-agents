    ...
    try:
        ...
        def replace_env_var(match):
            ...
            if var_name in env_vars:
                ...
                print(f"⚠️  Warning: Environment variable {var_name} not found for {source_file.name}")
...
def prepare_components(components_dir, env_vars):
    ...
    print(f"📁 Processing components from {source_components_dir} to {temp_components_dir}")
    ...
    print(f"📊 Component processing summary: {processed_count} processed, {skipped_count} skipped")
