...
def main():
    ...
    print(f"{Fore.CYAN}🚀 Testing Dapr Conversation with Echo Component{Style.RESET_ALL}")
    print(f"{Fore.YELLOW}This example demonstrates LLM conversation without requiring API keys{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}📝 Note: Streaming support is in development and coming soon!{Style.RESET_ALL}\n")
    ...
    try:
        ...
        print(f"{Fore.YELLOW}💡 Make sure Dapr sidecar is running with echo component{Style.RESET_ALL}")
        return
    ...
    conversation = [
        ...
        {"role": "assistant", "content": "I enjoy discussing the concept of blue - it represents depth and tranquility."},
    ...
    for msg in conversation:
        ...
        print(f"   {role_color}{msg['role'].title()}:{Style.RESET_ALL} {msg['content']}")
