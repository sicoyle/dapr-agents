...
def run_enhanced_tool_calling_example(provider: str = "openai"):
    ...
    try:
        ...
        print("📋 Step 2: Building conversation history with enhanced DaprChatClient...")
            ...
            "tool_calls": [
                {
                    ...
                    "function": {
                        ...
                        "arguments": tc.arguments if hasattr(tc, 'arguments') else tc.function.arguments
                    }
                }
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Enhanced DaprChatClient Tool Calling Example")
    parser.add_argument(
        "--provider",
        default="openai",
