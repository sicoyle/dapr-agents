...
def main():
    ...
    print(f"{Fore.YELLOW}This example demonstrates intelligent tool selection with streaming responses{Style.RESET_ALL}\n")
    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        try:
            ...
            if tool_calls_made:
                print(f"{Fore.GREEN}🎯 Tools used: {[tc.get('name') for tc in tool_calls_made]}{Style.RESET_ALL}")
            else:
