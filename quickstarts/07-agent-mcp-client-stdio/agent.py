...
def main() -> None:
    ...
    try:
        ...
        logging.exception("Failed to load MCP tools via STDIO")
        return

    # asyncio.run tears down its loop; create a fresh default for sync wiring.
    ...
    agent = DurableAgent(
        ...
        goal="Help humans get weather, travel, and location details using MCP tools.",
        instructions=[
