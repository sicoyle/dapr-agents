...
logger = logging.getLogger("translator.publisher")

PUBSUB_NAME = os.getenv("PUBSUB_NAME", "messagepubsub")
TOPIC_NAME = os.getenv("TOPIC_NAME", "translator.intake.requests")
CONTENT_TYPE = os.getenv("CONTENT_TYPE", "application/json")
CLIENT_SOURCE = os.getenv("CLIENT_SOURCE", "quickstarts.translator.client")
