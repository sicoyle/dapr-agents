# Standalone Agent Tool Call with Dapr Agents
...
You can access and manage the agent's conversation history too. Add this code fragment to the end of `standalone_weather_agent_dapr.py` and run it again.

```python
# View the history after first interaction
print("Chat history after first interaction:")
print(AIAgent.get_chat_history())
...
print(AIAgent.get_chat_history())  # Should be empty now
```
